...
class CRUDAndValidationTests(APITestCase):
    ...
    def test_FT_01_buat_laporan_dengan_data_lengkap(self):
        ...
        """
        url = reverse('api_report-list')
        payload = {
            'title': 'Jalan Rusak di Pasar',
        ...
        self.assertEqual(
            ...
            "Sistem seharusnya menerima data yang lengkap dengan HTTP 201."
        )
    ...
    def test_FT_02_ditolak_jika_judul_kosong(self):
        ...
        self.assertEqual(
            ...
            "Sistem harus menolak data tanpa judul (title) dengan HTTP 400."
        )
    ...
    def test_FT_03_ditolak_jika_deskripsi_kosong(self):
        ...
        payload = {
            'title': 'Jalan Rusak di Pasar',
            'category': 'Infrastruktur',
            # 'description' sengaja dihilangkan
            'location': 'Pasar Tengah'
        }
        ...
        self.assertEqual(
            response.status_code, 
            status.HTTP_400_BAD_REQUEST,
            "Sistem harus menolak data tanpa deskripsi (description) dengan HTTP 400."
        )
