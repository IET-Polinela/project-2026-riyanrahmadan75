...
from rest_framework import viewsets, filters # Ditambahkan 'filters'
from rest_framework.pagination import PageNumberPagination
from rest_framework.permissions import IsAuthenticated, AllowAny

# LAB 14 IMPORTS
from drf_spectacular.utils import extend_schema # Untuk dokumentasi API
...
# ==========================================
# API REST FRAMEWORK CONFIG (LAB 10 & 14)
# ==========================================
...
@extend_schema(tags=['Reports']) # Tag untuk Swagger
